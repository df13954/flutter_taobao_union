...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case UnionCategoriesEntity:
			...
			return unionCategoriesDataFromJson(data as UnionCategoriesData, json) as T;    }
    return data as T;
  }
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case UnionCategoriesEntity:
			...
			return unionCategoriesDataToJson(data as UnionCategoriesData);    }
    return data as T;
  }
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'UnionCategoriesEntity':
			...
			return UnionCategoriesData().fromJson(json);    }
    return null;
  }
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'UnionCategoriesEntity':
			...
			return List<UnionCategoriesData>();    }
    return null;
  }
